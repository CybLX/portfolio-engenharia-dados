...
def homepage(embedded=False):
    ...
    <section id="team" class="section team-section"><div class="wrap"><div class="section-top"><div><div class="eyebrow">A equipe</div><h2>Dois engenheiros.<br>O mesmo foco na entrega.</h2></div><p>Experiência profissional em engenharia de dados corporativa, aplicada a projetos freelancer com escopo bem definido.</p></div><div class="team-grid"><article class="person"><div class="number">ENGENHEIRO / 01</div><h3>Bruno Santos</h3><div class="role">Especialista em Engenharia de Dados</div><div class="pending">Perfil e contribuições individuais no projeto<br>a confirmar antes da publicação.</div></article><article class="person"><div class="number">ENGENHEIRO / 02</div><h3>Lucas Alves</h3><div class="role">Especialista em Inteligência Artificial</div><div class="pending">Nome público, perfil e contribuições no projeto<br>a confirmar antes da publicação.</div></article></div></div></section>
